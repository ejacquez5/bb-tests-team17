...
class Size3x3Mixed5_4Test {
	...
	void test() {
		...
		//Test 3 x 3 matrix
		int [] vals = { 3, 8, 4, 		//5 positives and 4 negatives
				-6, 5, -1,
				9, -2, -10 
				};
		int N = vals.length;
		...
		System.out.printf("3x3 Mixed5_4 Table sorted: %s", TableSorter.isSorted(t1)); //should return
		       //false
	}
