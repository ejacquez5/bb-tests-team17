...
class Size2x2MixedValTest2 {
	...
	void test() {
		...
		//Test 2 x 2 matrix
		int [] vals = { -1, 2, 		//3 negatives and one positive
				-4, -11};
		int N = vals.length;
		Table t1 = null;
		try {
		...
		System.out.printf("2x2 Mixed Val 2 Table sorted: %s", TableSorter.isSorted(t1)); //should return
		       //false
	}
