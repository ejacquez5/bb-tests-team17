...
class Size3x3Mixed3_6Test {
	...
	void test() {
		...
		//Test 3 x 3 matrix
		int [] vals = { 3, -8, 4, 		//3 positives and 6 negatives
				-6, -5, -1,
				9, -2, -10 
				};
		int N = vals.length;
		...
		System.out.printf("3x3 Mixed3_6 Table sorted: %s", TableSorter.isSorted(t1)); //should return
		       //false
	}
