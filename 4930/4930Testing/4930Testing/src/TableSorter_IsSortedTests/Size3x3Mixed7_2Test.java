...
class Size3x3Mixed7_2Test {
	...
	void test() {
		...
		//Test 3 x 3 matrix
		int [] vals = { 3, 8, 4, 		//7 positives and 2 negatives
				6, 5, 1,
				9, -2, -10 
				};
		int N = vals.length;
		...
		System.out.printf("3x3 Mixed7_2 Table sorted: %s", TableSorter.isSorted(t1)); //should return
		       //false
	}
